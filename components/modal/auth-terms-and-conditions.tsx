      ...
      >
        ...
        <div className="overflow-y-auto h-full pb-16">
          ...
          <p className="mt-2">
            ...
            conditions. Do not continue to use Benyaan if you do not agree to
          ...
          <p className="mt-2">
            We employ the use of cookies. By accessing Benyaan, you agreed to
            use cookies in agreement with the {'Get Med Go'} Privacy Policy.{' '}
          </p>
          ...
          <p className="mt-2">
            Unless otherwise stated, Benyaan and/or its licensors own the
            intellectual property rights for all material on Benyaan. All
            intellectual property rights are reserved. You may access this from
            Benyaan for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p className="mt-2">You must not:</p>
          <ul className="list-disc px-6">
            <li>Republish material from Benyaan</li>
            <li>Sell, rent or sub-license material from Benyaan</li>
            <li>Reproduce, duplicate or copy material from Benyaan</li>
            <li>Redistribute content from Benyaan</li>
          </ul>
          ...
          <p className="mt-2">
            ...
            Benyaan does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Benyaan,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Benyaan shall
          ...
          <p className="mt-2">
            Benyaan reserves the right to monitor all Comments and to remove any
          ...
          <p className="mt-2">
            You hereby grant Benyaan a non-exclusive license to use, reproduce,
          ...
          <p className="mt-2">
            ...
            visibility of the hyperlink compensates the absence of Benyaan; and
          ...
          <p className="mt-2">
            ...
            sending an e-mail to Benyaan. Please include your name, your
          ...
          <p className="mt-2">
            No use of {'Get Med Go'} logo or other artwork will be allowed for
