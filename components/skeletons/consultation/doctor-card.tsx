export default function DoctorCardSkeleton(): JSX.Element {
  return (
    <div
      className="shadow-lg rounded-lg py-4 px-6
        md:grid grid-cols-3 smooth-animate hover:shadow-2xl border"
    >
      <div className="sm:flex col-span-2 sm:space-x-5 items-center">
        <div className="w-48 sm:mx-0 mx-auto sm:mb-0 mb-4">
        ...
        <div className="h-full flex flex-col pt-2 w-full    overflow-hidden">
          <div className="skeleton rounded-lg  h-7 sm:w-40 w-full mb-1"></div>
